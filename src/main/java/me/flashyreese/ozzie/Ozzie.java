...
public class Ozzie implements Plugin {
    ...
    public void initializePlugin() {
        ...
        OzzieApi.INSTANCE.getCommandManager().registerCommand(new Identifier("ozzie", "client"), new ClientCommand());
    ...
    public void terminatePlugin() {
        ...
        OzzieApi.INSTANCE.getCommandManager().unregisterCommand(ClientCommand.class);
